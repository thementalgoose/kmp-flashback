...
import flashback.presentation.localisation.generated.resources.glossary_apex
import flashback.presentation.localisation.generated.resources.glossary_apex_desc
...
enum class Glossary(
    ...
    APEX(
        id = "APEX",
        label = string.glossary_apex,
        desc = string.glossary_apex_desc,
        since = 2022
    ),
    BARGE_BOARDS(
        id = "BARGE_BOARDS",
